Ohai.plugin(:Proxy) do
    ...
    collect_data do
        ...
        begin
          ...
          http_proxy_host  = URI.parse(http_proxy.chomp).host  
          http_proxy_port  = URI.parse(http_proxy.chomp).port  || 80
          https_proxy_host = URI.parse(https_proxy.chomp).host 
          https_proxy_port = URI.parse(https_proxy.chomp).port || 443
